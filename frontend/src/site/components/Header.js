                    ...
                    <ul className="menu-top navbar-nav">
                      ...
                      <li>
                        ...
                        <div className="dropdown-menu">
                          <ul>
                            <li className="item">
                              <a href="product.html" title="Blog List (Sidebar Left)">Đồng hồ</a>
                            </li>
                            <li className="item">
                              <a href="#" title="Blog List (Sidebar Left) 2">Tủ gỗ</a>
                            </li>
                            <li className="item">
                              <a href="" title="Category Blog (Right column)">Bàn ăn</a>
                            </li>
                            <li className="item">
                              <a href="" title="Blog List (No Sidebar)">Kệ sách</a>
                            </li>
                            <li className="item">
                              <a href="" title="Blog Grid (No Sidebar)">Ghế</a>
                            </li>
